...
trait PassportToken
{
    ...
    protected function sendBearerTokenRespose($accessToken, $refreshToken)
    {
    ...
    protected function getBearerTokenByUser(User $user, $clientId, $output = true)
    {
        ...
        $bearerToken = $this->sendBearerTokenRespose($passportToken['access_token'], $passportToken['refresh_token']);
